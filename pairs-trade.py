...
aktien = ['adidas AG','Allianz SE','BASF SE','BAYER AG','Beiersdorf AG','BMW AG','Commerzbank AG',
          'Continental AG','Daimler AG','Deutsche Bank AG','Deutsche B�rse AG','Deutsche Lufthansa AG',
          ...
          'K+S Aktiengesellschaft', 'LANXESS AG','Linde AG','Merck KGaA', 'M�nchener R�ck AG', 
...
backtest = pd.read_csv("dax_backtest.csv", index_col=0, parse_dates=True)
backtest.head()
